...
Asegurate de haber completado la [instalacion](/getting-started/installation) de todas las herramientas necesarias antes de continuar.
...
Este comando automatiza la configuracion inicial. Consulta la pagina de [configuracion inicial](/getting-started/setup) para ver el detalle de cada paso.
