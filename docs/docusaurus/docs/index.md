...
| Seccion | Descripcion |
|---------|-------------|
| [Producto](producto/propuesta-de-valor) | Propuesta de valor, segmentos, verticales, roadmap |
| [Empezar](getting-started/installation) | Instalacion y configuracion del entorno de desarrollo |
| [Backend](backend) | Serverpod v3.4.1, 10 dominios, 30 modelos, PostgreSQL |
| [Mobile](mobile) | Flutter + Riverpod + GoRouter, 4 segmentos de usuario |
| [IoT](iot) | Raspberry Pi, 8 sensores Atlas Scientific, simulacion |
| [Pagos](pagos/latam-payments) | latam_payments SDK — OnvoPay, Tilopay, Wompi |
| [Arquitectura](architecture/overview) | Diagrama del sistema, flujo de datos, tecnologias |
| [Despliegue](deployment/kubernetes) | Kubernetes, EMQX, ArgoCD, Balena |
| [Desarrollo](development/local-setup) | Entorno local, estructura del monorepo, testing |
| [Estrategia](estrategia/srd) | SRD framework, Linear, ciclos y roadmap |
...
[Ver documentacion IoT completa →](iot)
...
- [SRD Framework](estrategia/srd) — Estrategia de producto completa
- [Linear Project](https://linear.app/vertivolatam/project/vertivo-dollar500k-mrr-9b6ce5d7223c) — 28 issues, 8 ciclos
- [AGENTS.md](https://github.com/vertivolatam/monorepo/blob/main/AGENTS) — Instrucciones para agentes AI
