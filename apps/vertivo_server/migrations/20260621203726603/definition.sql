...
--
-- Class AlertTemplate as table alert_templates
--
...
--
-- Class Anomaly as table anomalies
--
...
--
-- Class ComplianceReport as table compliance_reports
--
...
--
-- Class ComplianceTemplate as table compliance_templates
--
...
--
-- Class CropModel as table crop_models
--
CREATE TABLE "crop_models" (
    ...
    "idealPhIdeal" double precision,
    "idealCo2Min" double precision,
    "idealCo2Max" double precision,
    "idealEcMinDsM" double precision,
    "idealEcMaxDsM" double precision,
    "idealNightTemperatureMin" double precision,
    "idealNightTemperatureMax" double precision,
    "idealOrpMinMv" double precision,
    "idealOrpMaxMv" double precision,
    "ppfdMin" double precision,
    "ppfdMax" double precision,
    "photoperiodHours" double precision,
    "lightSpectrum" text,
    "ediblePart" text,
    "priority" bigint,
    "aeroponicSuitable" boolean,
    "profileKey" text,
    "nutrientRecipeJson" text,
...
--
-- Class DiseaseDetection as table disease_detections
--
...
--
-- Class EnvironmentalReading as table environmental_readings
--
...
--
-- Class EscalationRule as table escalation_rules
--
...
--
-- Class Greenhouse as table greenhouses
--
...
--
-- Class GrowthStageDefinition as table growth_stage_definitions
--
...
--
-- Class HarvestPrediction as table harvest_predictions
--
...
--
-- Class IrrigationEvent as table irrigation_events
--
...
--
-- Class KpiMetric as table kpi_metrics
--
...
--
-- Class NotificationDelivery as table notification_deliveries
--
...
--
-- Class NutritionalDeficiency as table nutritional_deficiencies
--
...
--
-- Class PestIdentification as table pest_identifications
--
...
--
-- Class QualityPrediction as table quality_predictions
--
...
--
-- Class SecurityEvent as table security_events
--
...
--
-- Class TraceabilityRecord as table traceability_records
--
...
--
-- Class TreatmentRecommendation as table treatment_recommendations
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('vertivo', '20260621203726603', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260621203726603', "timestamp" = now();
